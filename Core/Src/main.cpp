...
static void MX_USART3_UART_Init(void)
{
 ...
 // This is the UART used for debug prints over the ST-Link USB interface. It is not used for MIDI output, which is brought up by the board-startup module before the UI starts sending MIDI messages.
