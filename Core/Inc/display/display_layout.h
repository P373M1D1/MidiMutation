...
#define MAIN_INFO_EDIT_FIELD_COUNT     (1U + PRESET_DEVICE_SLOTS + PRESET_RELAY_COUNT + (PRESET_CC_SLOT_COUNT * 3U) + 1U)
...
#define TRANSPORT_BARBEAT_TEXT_X        10U
#define TRANSPORT_BARBEAT_TEXT_Y        7U
