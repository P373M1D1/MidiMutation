...
#define MENU_DEVICE_EDIT_ITEM_RANDOM_BYPASS     2U
#define MENU_DEVICE_EDIT_ITEM_CHANNEL           3U
#define MENU_DEVICE_EDIT_ITEM_ACTIVE_CC         4U
#define MENU_DEVICE_EDIT_ITEM_ACTIVE_AUTO_FIRST 5U
