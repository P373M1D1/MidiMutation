...
#define MENU_GLOBAL_ITEM_BACKUP_TO_SD   10U
#define MENU_GLOBAL_ITEM_RESTORE_FROM_SD 11U
#define MENU_GLOBAL_ITEM_FACTORY_RESET  12U
#define MENU_EXPRESSION_ITEM_MODE       0U
#define MENU_EXPRESSION_ITEM_SET_HEEL   1U
#define MENU_EXPRESSION_ITEM_SET_TOE    2U
#define MENU_EXPRESSION_ITEM_INVERT     3U
#define MENU_EXPRESSION_ITEM_CC_FIRST   4U
#define MENU_EXPRESSION_ITEM_COUNT      (MENU_EXPRESSION_ITEM_CC_FIRST + RUNTIME_CONFIG_EXPRESSION_PEDAL_CC_SLOT_COUNT)
...
#define MENU_DEVICE_EDIT_ITEM_COUNT     (14U + (2U * RUNTIME_CONFIG_DEVICE_AUTO_CC_COUNT))
