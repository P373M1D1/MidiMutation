...
void ST7796_Test(void)
{
    ...
    uint16_t colors[] = { ST7796_RED, ST7796_GREEN, ST7796_BLUE,
                          ST7796_CYAN, ST7796_MAGENTA, ST7796_YELLOW, ST7796_WHITE };
    for (int i = 0; i < 7; i++) {
    ...
    HAL_Delay(300);
    ST7796_FillScreen(ST7796_RED);
    HAL_Delay(300);
    ST7796_FillScreen(ST7796_GREEN);
    HAL_Delay(300);
    ST7796_FillScreen(ST7796_BLUE);
    HAL_Delay(300);
    ST7796_FillScreen(ST7796_BLACK);

    /* Primitives */
    ST7796_DrawRectangle(10, 10, ST7796_WIDTH - 10, ST7796_HEIGHT - 10, ST7796_WHITE);
    ST7796_DrawFilledRectangle(20, 20, 80, 60, ST7796_RED);
    ST7796_DrawCircle(ST7796_WIDTH / 2, ST7796_HEIGHT / 2, 60, ST7796_YELLOW);
    ST7796_DrawFilledCircle(ST7796_WIDTH / 2, ST7796_HEIGHT / 2, 30, ST7796_CYAN);
    ST7796_DrawLine(0, 0, ST7796_WIDTH - 1, ST7796_HEIGHT - 1, ST7796_GREEN);
    ST7796_DrawLine(ST7796_WIDTH - 1, 0, 0, ST7796_HEIGHT - 1, ST7796_GREEN);

    /* Text */
    ST7796_WriteString(10, ST7796_HEIGHT - 30, "ST7796 OK", Font_7x10, ST7796_WHITE, ST7796_BLACK);
}
